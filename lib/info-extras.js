...
exports.getLikes = info => {
  try {
    ...
    /* 
      fix youtube change json in 2023/12/07
      @author: tienanh1472000@gmail.com
    */
    const likeAlternative = buttons[0].segmentedLikeDislikeButtonViewModel.likeButtonViewModel.likeButtonViewModel.toggleButtonViewModel.toggleButtonViewModel.defaultButtonViewModel.buttonViewModel.accessibilityText;
    return parseInt(likeAlternative.replace(/[^0-9]+/g, ''));
